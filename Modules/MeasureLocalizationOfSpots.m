...
try
    ...
    if any(findobj == ThisModuleFigureNumber)
        ...
        matDistancesToOutline_Temp = [0;matLocMeasurements(:,1)];
        ...
        colorbar
        title('Min. dist. to parent outline.')
        
        subplot(2,2,3);
        %     matDistancesToOutline_Temp = [0;matDisToOutlineThirdLine];
        matDistancesToOutline_Temp = [0;matLocMeasurements(:,5)];
        ...
        colormap(matColorMap)
        colorbar
        title('Dist. to parent outline projected from centroid')
        ...
        matDistancesToOutline_Temp = [0;matLocMeasurements(:,9)];
        ...
        matDistancesToOutline_Temp = [0;matLocMeasurements(:,6)];
    ...
    warning('Measurements could not be displayed. Please chaeck the settings')
end
